                        ...
                        <table className="min-w-full divide-y divide-blue-300 ">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td className="py-2 px-3 text-sm text-gray-700 whitespace-nowrap text-center">1258 $</td>  <td className="py-2 px-3 text-sm text-gray-700 whitespace-nowrap text-center">Geedoo Kanda</td>
