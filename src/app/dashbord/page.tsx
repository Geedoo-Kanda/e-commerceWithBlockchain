            ...
            <div className='grid lg:grid-cols-4 gap-4'>
                <div className='bg-white shadow-md shadow-pink-100 rounded-sm p-4'>
                    <div className='flex items-center'>
                        <span className='text-blue-500 text-4xl p-2 rounded-md font-semibold'>
                            2548
                        </span>
                        <span className='text-green-700 p-1 rounded-md relative text-xs bg-green-100'>
                            +14%
                        </span>
                    </div>
                ...
                <div className='bg-white shadow-purple-200 shadow-md rounded-sm p-4'>
                    <div className='flex items-center'>
                        ...
                        <span className='text-red-700 p-1 rounded-md relative text-xs bg-red-100'>
                            -5%
                        </span>
                    </div>
                    <div className='text-md text-end text-gray-600'>
                ...
                <div className='bg-white shadow-purple-200 shadow-md rounded-sm p-4'>
                    <div className='flex items-center'>
                        ...
                        <span className='text-yellow-700 p-1 rounded-md relative text-xs bg-yellow-100'>
                            +0%
                        </span>
                    </div>
                    <div className='text-md text-end text-gray-600'>
