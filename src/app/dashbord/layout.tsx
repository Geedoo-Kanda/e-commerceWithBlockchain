                ...
                <div className=''>
                    <div className='fixed w-[15%] h-screen overflow-auto shadow-lg bg-white'>
                        ...
                        <div className='mt-8'>
                            ...
                            <Link href={"/dashbord/users"} className='flex text-xs font-medium text-gray-800 items-center px-2 my-2 py-1.5 hover:text-white hover:bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 border-t border-gray-400 mt-6'>
                            ...
                            <Link href={"/dashbord/produits"} className='flex text-xs font-medium text-gray-800 items-center px-2 my-2 py-1.5 hover:text-white hover:bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500'>
