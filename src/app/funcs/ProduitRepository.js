...
import ProductRepositoryContract from './build/contracts/ProduitRepository.json';

const initProduitWeb3 = async () => {
    if (window.ethereum) {
...
const initProduitContract = async (web3) => {
    if (web3) {
...
const initProduitAccounts = async (web3) => {
    if (web3) {
