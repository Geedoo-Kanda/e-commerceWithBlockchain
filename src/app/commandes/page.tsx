...
export default function Commandes() {
    ...
    const [orderProdcuts, setOrderProdcuts] = useState<any>();
    const [prodcuts, setProdcuts] = useState<any>();
    ...
    useEffect(() => {
        const initBlockchain = async () => {
            ...
            if (accounts.length > 0) {
                ...
                setOrderProdcuts(tabOrderProducts);
                                                ...
                                                <tbody className="bg-white divide-y divide-gray-200">
                                                    {
                                                        orders?.map((order: any, index: any) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td className="py-2 px-3 text-sm text-gray-700 whitespace-nowrap text-center">{order.delivered ?
